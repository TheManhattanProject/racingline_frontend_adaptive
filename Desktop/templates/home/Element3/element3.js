	...
	return (
		<div className={styles.element3}>
			<div className={styles.element3row}>
				<div
					className={
						styles.element3container
					}
				>
					<div
						className={styles.leftUpperText}
					>
						what <br></br>can you <br></br>do
						with<br></br> racingline?
					</div>
					<div className={styles.upperflex}>
						<div>
							...
							<span>
								...
								<div
									className={
										styles.upperDescription
									}
								>
									Have a burning question about
									auto racing? Our community is
									the perfect place to get
									answers from other experts and
									enthusiasts.
								</div>
							</span>
						</div>
						<div>
							...
							<span>
								...
								>
									...
									field or have a knack for the
									field, you can help answer
			...
			<div className={styles.element3row2}>
				<div className={styles.lowerText}>
					With Racingline, interacting with
					people just like you has become
					easier.
					<span className={styles.hidden}>
						s
					</span>
					<span
						className={styles.lowerTextRed}
					>
						Finding your <br />
						own community and group of car
						lovers is just a few clicks away.
					</span>
				</div>
				<div className={styles.lowerText2}>
					...
					enthusiasts from
					<br /> around the world, make new
					friends, and share your love of{' '}
					<br /> sport.
				</div>
				<Image
					src={img4}
					className={styles.formulacar}
				/>
				<Image
					src={img5}
					className={styles.formulacarshort}
				/>
			</div>
			<div className={styles.element3row3}>
				...
				<div className={styles.textcenter}>
					Go on and take the wheel today!
				</div>
